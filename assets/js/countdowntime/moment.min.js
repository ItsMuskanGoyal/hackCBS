!(function (e, t) {
  ...
  function j(e, t, n) {
    e.isValid() &&
      !isNaN(n) &&
      ("FullYear" === t && E(e.year()) && 1 === e.month() && 29 === e.date()
  ...
  function X(e, t, n) {
    ...
    return (
      a < 1
        ? (s = a + K((i = e.year() - 1), t, n))
        : a > K(e.year(), t, n)
        ? ((s = a - K(e.year(), t, n)), (i = e.year() + 1))
        : ((i = e.year()), (s = a)),
      { week: s, year: i }
    );
  }
      ...
      if (((t.abbr = e), null != Xt[e]))
        ...
        if (null == Xt[t.parentLocale])
          return (
            ...
            Kt[t.parentLocale].push({ name: e, config: t }),
            null
          );
  ...
  function ue(e) {
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          t = (i = ie(e[r]).split("-")).length,
            n = (n = ie(e[r + 1])) ? n.split("-") : null;
          t > 0;
    ...
    return (
      n &&
        ...
        ((t =
          n[xt] < 0 || n[xt] > 11
            ? xt
            : n[bt] < 1 || n[bt] > Z(n[Tt], n[xt])
            ? bt
            : n[Pt] < 0 ||
              n[Pt] > 24 ||
              (24 === n[Pt] && (0 !== n[Wt] || 0 !== n[Ht] || 0 !== n[Rt]))
            ? Pt
            : n[Wt] < 0 || n[Wt] > 59
            ? Wt
            : n[Ht] < 0 || n[Ht] > 59
    ...
    if (!t._d) {
      for (
        i = (function (t) {
          ...
          null != t._dayOfYear &&
            ((a = de(t._a[Tt], i[Tt])),
            (t._dayOfYear > V(a) || 0 === t._dayOfYear) &&
        ...
        for (i = R(t._f, t._locale).match(rt) || [], n = 0; n < i.length; n++)
          (r = i[n]),
            (s = (o.match(F(r, t)) || [])[0]) &&
              ...
              (l += s.length)),
            ut[r]
              ? (s ? (d(t).empty = !1) : d(t).unusedTokens.push(r), G(r, s, t))
  ...
  (Dn.add = _n),
    ...
    (Dn.from = function (e, t) {
      return this.isValid() && ((_(e) && e.isValid()) || pe(e).isValid())
    ...
    (Dn.toISOString = function (e) {
      ...
      return n.year() < 0 || n.year() > 9999
        ...
        ? t
          ...
          : new Date(this._d.valueOf()).toISOString().replace("Z", H(n, "Z"))
        : H(
            n,
    ...
    (Dn.utcOffset = function (t, n, s) {
      ...
      if (null != t) {
        ...
        return (
          !this._isUTC && n && (i = Oe(this)),
          (this._offset = t),
          (this._isUTC = !0),
          null != i && this.add(i, "m"),
          r !== t &&
            (!n || this._changeInProgress
              ? He(this, xe(t - r, "m"), 1, !1)
  ...
  (kn.calendar = function (e, t, n) {
    ...
    (kn.months = function (e, n) {
      return e
        ? t(this._months)
          ...
          : this._months[
              (this._months.isFormat || Nt).test(n) ? "format" : "standalone"
            ][e.month()]
        : t(this._months)
        ? this._months
    ...
    (kn.monthsShort = function (e, n) {
      return e
        ? t(this._monthsShort)
          ...
          : this._monthsShort[Nt.test(n) ? "format" : "standalone"][e.month()]
        : t(this._monthsShort)
        ? this._monthsShort
    ...
    (kn.monthsParse = function (e, t, n) {
      ...
      if (this._monthsParseExact)
        return function (e, t, n) {
          ...
          return n
            ? "MMM" === t
              ? -1 !== (i = Ut.call(this._shortMonthsParse, a))
                ? i
                : null
              : -1 !== (i = Ut.call(this._longMonthsParse, a))
              ? i
              : null
            : "MMM" === t
            ? -1 !== (i = Ut.call(this._shortMonthsParse, a))
    ...
    (kn.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (o(this, "_monthsRegex") || q.call(this),
    ...
    (kn.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (o(this, "_monthsShortRegex") || (this._monthsShortRegex = Et),
    ...
    (kn.weekdaysParse = function (e, t, n) {
      ...
      if (this._weekdaysParseExact)
        return function (e, t, n) {
          ...
          return n
            ? "dddd" === t
              ? -1 !== (i = Ut.call(this._weekdaysParse, a))
                ? i
                : null
              : "ddd" === t
              ? -1 !== (i = Ut.call(this._shortWeekdaysParse, a))
                ? i
                : null
              : -1 !== (i = Ut.call(this._minWeekdaysParse, a))
              ? i
              : null
            : "dddd" === t
            ? -1 !== (i = Ut.call(this._weekdaysParse, a))
    ...
    (kn.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ? (o(this, "_weekdaysRegex") || ee.call(this),
          e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        : (o(this, "_weekdaysRegex") || (this._weekdaysRegex = zt),
    ...
    (kn.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (o(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $t),
    ...
    (kn.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (o(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = qt),
  ...
  return (
    ...
    (e.updateLocale = function (e, t) {
      if (null != t) {
        ...
        null != Xt[e] &&
          (null != Xt[e].parentLocale
            ? (Xt[e] = Xt[e].parentLocale)
            : null != Xt[e] && delete Xt[e]);
      return Xt[e];
    }),
    (e.locales = function () {
      return nt(Xt);
